...
if wandbCallbacks:
    ...
    wandb.init(project='SuperRes', config=config, id="gen_128"+ datetime.now().strftime('_%m-%d_%H:%M'))
...
if wandbCallbacks:
    ...
    wandb.init(project='SuperRes', config=config, id="gen_256_" + datetime.now().strftime('_%m-%d_%H:%M'))
